...
<div class="table-responsive-sm" style="min-height: 200px;">
@if(!empty($data))
...
<table class="table table-bordered table table-striped table table-sm">
   ...
   <tr>        
    ...
    <tr><th>Authorised Capital(Rs)</th><td><?php echo $data['authorized_cap']; ?></td></tr>
    <tr><th>Paid up Capital(Rs)</th><td><?php echo $data['paidup_capital']; ?></td></tr>
