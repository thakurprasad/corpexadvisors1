<div class="side-header oh">
    ...
    <div class="site-header-container">
        ...
        <ul class="dashboard-menu">
            <li>
                <a href="{{ url('/affiliate/dashboard') }}" class="active"><i class="flaticon-man"></i>Dashboard</a>
            </li>
            <li>
                <a href="{{ url('/affiliate/dashboard') }}" class="active"><i class="flaticon-man"></i>Affiliate</a>
            </li>
