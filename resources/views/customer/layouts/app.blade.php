...
<head>
    ...
    <title>Customer : <?= (isset($title) ? $title: '' ) ?></title>
                                            ...
                                            <div class="notification-area">
                                                ...
                                                <div class="author-body">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="{{ url('customer/update-profile/'.Helper::_encrypt(\Auth::user()->id)) }}"><i class="fas fa-user-edit"></i>Edit Profile</a>
                                                        </li>
                                                        <li>
                                                            <a href="{{ route('logout') }}"
