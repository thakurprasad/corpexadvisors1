                ...
                <div class="container-fluid">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="dashboard-item">
                                <div class="dashboard-inner">
                                    ...
                                    <div class="thumb">
                                        <img src="{{ url('public/assets/images/dashboard/dashboard1.png') }}" alt="dasboard">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-3">
                            <div class="dashboard-item">
                                <div class="dashboard-inner">
                                    ...
                                    <div class="thumb">
                                        <img src="{{ url('public/assets/images/dashboard/dashboard2.png') }}" alt="dasboard">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-3">
                            <div class="dashboard-item">
                                <div class="dashboard-inner">
                                    ...
                                    <div class="thumb">
                                        <img src="{{ url('public/assets/images/dashboard/dashboard3.png') }}" alt="dasboard">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-3">
                            <div class="dashboard-item">
                                <div class="dashboard-inner">
                                    ...
                                    <div class="thumb">
                                        <img src="{{ url('public/assets/images/dashboard/dashboard4.png') }}" alt="dasboard">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row pb-30">
                            ...
                            <div class="total-earning-item">
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="item">
                                        ...
                                        <div class="thumb">
                                            <img src="{{ url('public/assets/images/dashboard/graph1.png') }}" alt="dashboard">
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="cont">
                                        ...
                                        <div class="thumb">
                                            <img src="{{ url('public/assets/images/dashboard/graph2.png') }}" alt="dashboard">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-6">
                            <div class="earn-item mb-30">
                                <div class="earn-thumb">
                                    <img src="{{ url('public/assets/images/dashboard/earn/01.png') }}" alt="dashboard-earn">
                                </div>
                                <div class="earn-content">
                                    ...
                                    <ul class="mb--5">
                                        <li>
                                            <div class="icon">
                                                <img src="{{ url('public/assets/images/dashboard/earn/usd.png') }}" alt="dashboard-earn">
                                            </div>
                                            <div class="cont">
                                        ...
                                        <li>
                                            <div class="icon">
                                                <img src="{{ url('public/assets/images/dashboard/earn/btc.png') }}" alt="dashboard-earn">
                                            </div>
                                            <div class="cont">
                                        ...
                                        <li>
                                            <div class="icon">
                                                <img src="{{ url('public/assets/images/dashboard/earn/xrp.png') }}" alt="dashboard-earn">
                                            </div>
                                            <div class="cont">
                                                <span class="cl-1">0.000000</span>
                                        ...
                                        <li>
                                            <div class="icon">
                                                <img src="{{ url('public/assets/images/dashboard/earn/eth.png') }}" alt="dashboard-earn">
                                            </div>
                                            <div class="cont">
                                                <span class="cl-1">0.000000</span>
                        ...
                        <div class="col-lg-6">
                            <div class="earn-item mb-30">
                                <div class="earn-thumb">
                                    <img src="{{ url('public/assets/images/dashboard/earn/02.png') }}" alt="dashboard-earn">
                                </div>
                                <div class="earn-content partner-content d-flex flex-wrap align-items-start justify-content-between">
                                    ...
                                    <ul class="mb--5">
                                        <li>
                                            <div class="icon">
                                                <img src="{{ url('public/assets/images/dashboard/earn/active.png') }}" alt="dashboard-earn">
                                            </div>
                                            <div class="cont">
                                        ...
                                        <li>
                                            <div class="icon">
                                                <img src="{{ url('public/assets/images/dashboard/earn/inactive.png') }}" alt="dashboard-earn">
                                            </div>
                                            <div class="cont">
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="earn-item mb-30">
                                <div class="earn-thumb">
                                    <img src="{{ url('public/assets/images/dashboard/earn/03.png') }}" alt="dashboard-earn">
                                </div>
                                <div class="earn-content">
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="earn-item mb-30">
                                <div class="earn-thumb">
                                    <img src="{{ url('public/assets/images/dashboard/earn/04.png') }}" alt="dashboard-earn">
                                </div>
                                <div class="earn-content">
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="earn-item mb-30">
                                <div class="earn-thumb">
                                    <img src="{{ url('public/assets/images/dashboard/earn/05.png') }}" alt="dashboard-earn">
                                </div>
                                <div class="earn-content">
                        ...
                        <div class="col-lg-6">
                            <div class="earn-item small-thumbs mb-30">
                                <div class="earn-thumb">
                                    <img src="{{ url('public/assets/images/dashboard/earn/06.png') }}" alt="dashboard-earn">
                                </div>
                                <div class="earn-content">
                                    ...
                                    <ul class="mb--5">
                                        <li>
                                            <div class="cont w-100 p-0">
                                                ...
                                                <a href="Mailto:demo@mail.com" class="cl-4">Email: demo@mail.com</a>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="earn-item small-thumbs mb-30">
                                <div class="earn-thumb">
                                    <img src="{{ url('public/assets/images/dashboard/earn/07.png') }}" alt="dashboard-earn">
                                </div>
                                <div class="earn-content">
