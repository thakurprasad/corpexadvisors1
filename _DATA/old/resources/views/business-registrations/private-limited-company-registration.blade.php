...
@section('body')
  	...
  	<!--=======Banner-Section Starts Here=======-->
        <section class="hero-section bg_img" data-background="{{ url('public/assets/images/about/hero-bg.png') }}">
            <div class="container">
        ...
        <section class="ceo-section padding-bottom padding-top bg_img" data-background="{{ url('public/assets/images/about/ceo-bg.jpg') }}">
            <div class="container">
                    ...
                    <div class="col-lg-7 col-xl-6">
                        <div class="ceo-content">
                            ...
                            <div class="author">
                                ...
                                <div class="sign">
<img src="{{ url('public/assets/images/about/sign-ceo.png') }}" alt="about">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-xl-3">
                        <div class="ceo-thumb">
                            <img src="{{ url('public/assets/images/about/certificate-ceo.png') }}" alt="about">
                        </div>
        ...
        <section class="investor-section padding-bottom padding-top pt-max-lg-0">
            <div class="ball-group-1 ball-group-4" data-paroller-factor="-0.30" data-paroller-factor-lg="0.60" data-paroller-type="foreground" data-paroller-direction="horizontal">
                <img src="{{ url('public/assets/images/balls/ball-group4.png') }}" alt="balls">
            </div>
            <div class="ball-group-2 ball-group-3" data-paroller-factor="0.30" data-paroller-factor-lg="-0.30" data-paroller-type="foreground" data-paroller-direction="horizontal">
                <img src="{{ url('public/assets/images/balls/ball-group3.png') }}" alt="balls">
            </div>
            <div class="container">
                <div class="row justify-content-center">
                ...
                <div class="owl-carousel owl-theme investor-slider">
                    <div class="investor-item">
                        <div class="investor-thumb">
                            <img src="{{ url('public/assets/images/investor/investor1.png') }}" alt="investor">
                        </div>
                    ...
                    <div class="investor-item">
                        <div class="investor-thumb">
                            <img src="{{ url('public/assets/images/investor/investor2.png') }}" alt="investor">
                        </div>
                        <div class="investor-content">
                    ...
                    <div class="investor-item">
                        <div class="investor-thumb">
                            <img src="{{ url('public/assets/images/investor/investor3.png') }}" alt="investor">
                        </div>
                        <div class="investor-content">
                    ...
                    <div class="investor-item">
                        <div class="investor-thumb">
                            <img src="{{ url('public/assets/images/investor/investor4.png') }}" alt="investor">
                        </div>
                        <div class="investor-content">
